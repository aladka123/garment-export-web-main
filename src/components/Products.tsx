...
export default function Products() {
  const productCategories = [
    ...
    },
    {
      ...
      image:
        "https://cdn.pixabay.com/photo/2021/12/14/02/36/military-6869504_1280.jpg",
    ...
    },
    {
      ...
      image:
        "https://media.vietnamplus.vn/images/412d7a512dc574658776239cdcb9e9320771d2832caf6130279f6381622b424c243a28fe72124373cff83267e23e3cb5e4589c8f34396b77dddf906085b0f578f208e23f8ddae4e340ec92f05f03cc13f7d0a658ed3d1f06ad3e6f23aef8daeb/Testsfordopinginsportsfailtopickupmajorityofcases.jpg",
    ...
    },
    {
      ...
      image:
        "https://cdn-together.hellohealthgroup.com/2025/01/1738162732_679a422cb89b08.83909384",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            From concept to finished product, we manufacture a wide range of
            high-quality garments tailored to your specifications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {productCategories.map((category, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-slate-50 rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300"
              >
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {category.materials.map((material, idx) => (
                          <span
                            key={idx}
                            className="bg-white px-3 py-1 rounded-full text-sm text-slate-700 border border-slate-200"
                          >
                            {material}
                          </span>
                        ))}
        ...
        <div className="mt-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-12 text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Don't see exactly what you need? We specialize in custom garment
            manufacturing to bring your unique designs to life with precision
            and quality.
          </p>
          <button
            onClick={() => {
